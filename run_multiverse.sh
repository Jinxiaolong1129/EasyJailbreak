...
nohup python run_multiverse.py --target_model gpt-4 --start_num 0 --end_num 250 > run_multiverse_gpt-4.log 2>&1 &

nohup python run_multiverse.py --target_model vicuna-7b > run_multiverse_vicuna-7b.log 2>&1 &

CUDA_VISIBLE_DEVICES=4,5 nohup python run_multiverse.py --target_model llama-2-7b --start_num 251 --end_num 520 > run_multiverse_llama-2-7b.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=4,5 nohup python run_multiverse.py --target_model chatglm2-6b --start_num 0 --end_num 520 > run_multiverse_chatglm2-6b.log 2>&1 &
